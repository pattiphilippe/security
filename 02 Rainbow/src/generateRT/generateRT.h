...
inline const unsigned NB_HEAD = 10000; /**< How many password we generate for the RT */
...
inline const std::string DB_NAME("rsc/rt_5_3_10000_50000.sqlite"); /**< The relative path to the DB */
