...
constexpr char *DROP_RT = "DROP TABLE IF EXISTS RAINBOW_TABLE;";
constexpr char *CREATE_RT = "CREATE TABLE RAINBOW_TABLE (head CHAR(8) PRIMARY KEY, tail CHAR(8) NOT NULL UNIQUE);";
constexpr char *INSERT_RT = "INSERT INTO RAINBOW_TABLE (head, tail) VALUES (?, ?);";
constexpr std::string DB_NAME("rsc/rt_5_4_10000_50000.sqlite"); /**< The relative path to the DB */
