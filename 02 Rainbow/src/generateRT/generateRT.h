...
constexpr unsigned NB_HEAD = 1000000; /**< How many password we generate for the RT */
constexpr int NB_REDUCE = 10000;    /**< How many reduce function we use before getting the tail */
